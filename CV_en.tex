...
\cventry{2017\textendash current}{Software engineer}{Vela Solaris AG}{}{}
{
  ...
  \begin{itemize}
    ...
    \item Plugins (e.g. for co-simulations with \texttt{Python}/\texttt{Matlab}/PLC controllers).
  ...
  \begin{itemize}
    ...
    \item Maintenance of Docker containers.
...
\cventry{2016}{Intern/project work}{}{Vela Solaris AG}{Winterthur}{Implementation and validation of the PVprog algorithm in Polysun.}
...
\cvitem{Software development}{FOSS/Linux development, Trade literature}
