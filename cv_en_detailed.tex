...
\extrainfo{\href{https://github.com/mrcjkb}{\faIcon{github} mrcjkb}\\ \href{https://mrcjkb.dev}{\faIcon{link} mrcjkb.dev}\\ \href{https://www.linkedin.com/in/marc-jakobi/}{\faIcon{linkedin} marc-jakobi}}
...
\textbf{distributed systems and functional software engineering}.
Proven track record in \textbf{building reliable backend platforms}, shaping clean architectures,
and improving software delivery through \textbf{test automation, CI/CD, reproducible builds, and XP practices}.
}
...
\cvitem{Renewable energy}{Photovoltaics, batteries, e-mobility, thermal systems, sector coupling, energy management, virtual power plants}
...
\section{\faIcon{briefcase} Professional interests}
...
\cvitem{English}{Bilingual native proficiency}

\cvitem{German}{Bilingual native proficiency}
