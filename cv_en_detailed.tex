...
\cventry{2022\textendash current}{Backend developer}{tiko Energy Solutions AG}{}{} 
{
  ...
  \begin{itemize}
    ...
    \item Developed KVM-based integration tests using the \code{nixosTest} framework.
    \\
  \end{itemize}
...
\cvitem{nixpkgs}{Maintainer of various packages and NixOS modules}
\cvitem{nix-community}{Lua ecosystem}
\cvitem{nvim-neorocks}{Revolutionising the Neovim plugin ecosystem}
\cvitem{neovim}{Core contributions + maintainer of various plugins for Haskell, Nix and Rust development}
...
\cvitem{Software development}{FOSS/Linux development, Trade literature, Hackathons, SoCraTes}
